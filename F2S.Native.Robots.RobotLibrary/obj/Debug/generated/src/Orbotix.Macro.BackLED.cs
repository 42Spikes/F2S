...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']"
	[global::Android.Runtime.Register ("orbotix/macro/BackLED", DoNotGenerateAcw=true)]
	public partial class BackLED : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/BackLED", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BackLED); }
		}

		protected BackLED (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_II;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/constructor[@name='BackLED' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
		public BackLED (int p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (BackLED)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/constructor[@name='BackLED' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public BackLED (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.BackLED __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.BackLED> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Delay {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getDelay' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='setDelay' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetGetIntensityHandler ()
		{
			if (cb_getIntensity == null)
				cb_getIntensity = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_GetIntensity);
			return cb_getIntensity;
		}

		static int n_GetIntensity (IntPtr jnienv, IntPtr native__this)
		{
			global::Orbotix.Macro.BackLED __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.BackLED> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static Delegate cb_setIntensity_I;
#pragma warning disable 0169
		static Delegate GetSetIntensity_IHandler ()
		{
			if (cb_setIntensity_I == null)
				cb_setIntensity_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetIntensity_I);
			return cb_setIntensity_I;
		}

		static void n_SetIntensity_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Orbotix.Macro.BackLED __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.BackLED> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Intensity = p0;
		}
#pragma warning restore 0169
		...
		static IntPtr id_setIntensity_I;
		public virtual int Intensity {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getIntensity' and count(parameter)=0]"
			[Register ("getIntensity", "()I", "GetGetIntensityHandler")]
			get {
				if (id_getIntensity == IntPtr.Zero)
					id_getIntensity = JNIEnv.GetMethodID (class_ref, "getIntensity", "()I");

				if (GetType () == ThresholdType)
					return JNIEnv.CallIntMethod  (Handle, id_getIntensity);
				else
					return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getIntensity", "()I"));
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='setIntensity' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setIntensity", "(I)V", "GetSetIntensity_IHandler")]
			set {
				if (id_setIntensity_I == IntPtr.Zero)
					id_setIntensity_I = JNIEnv.GetMethodID (class_ref, "setIntensity", "(I)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setIntensity_I, new JValue (value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setIntensity", "(I)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='BackLED']/method[@name='getByteRepresentation' and count(parameter)=0]"
