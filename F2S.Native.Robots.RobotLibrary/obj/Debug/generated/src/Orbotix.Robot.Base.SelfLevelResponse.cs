...
namespace Orbotix.Robot.Base {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SelfLevelResponse']"
	[global::Android.Runtime.Register ("orbotix/robot/base/SelfLevelResponse", DoNotGenerateAcw=true)]
	public partial class SelfLevelResponse : global::Orbotix.Robot.Internal.DeviceResponse {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SelfLevelResponse']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/robot/base/SelfLevelResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SelfLevelResponse); }
		}

		protected SelfLevelResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorbotix_robot_internal_DeviceCommand_Lorbotix_robot_internal_DeviceResponse_ResponseCode_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SelfLevelResponse']/constructor[@name='SelfLevelResponse' and count(parameter)=3 and parameter[1][@type='orbotix.robot.internal.DeviceCommand'] and parameter[2][@type='orbotix.robot.internal.DeviceResponse.ResponseCode'] and parameter[3][@type='byte[]']]"
		[Register (".ctor", "(Lorbotix/robot/internal/DeviceCommand;Lorbotix/robot/internal/DeviceResponse$ResponseCode;[B)V", "")]
		public SelfLevelResponse (global::Orbotix.Robot.Internal.DeviceCommand p0, global::Orbotix.Robot.Internal.DeviceResponse.ResponseCode p1, byte[] p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p2 = JNIEnv.NewArray (p2);;
			if (GetType () != typeof (SelfLevelResponse)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SelfLevelResponse']/constructor[@name='SelfLevelResponse' and count(parameter)=1 and parameter[1][@type='android.os.Parcel']]"
		[Register (".ctor", "(Landroid/os/Parcel;)V", "")]
		protected SelfLevelResponse (global::Android.OS.Parcel p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
