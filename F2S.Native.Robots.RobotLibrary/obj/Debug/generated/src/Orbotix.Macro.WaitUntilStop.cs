...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']"
	[global::Android.Runtime.Register ("orbotix/macro/WaitUntilStop", DoNotGenerateAcw=true)]
	public partial class WaitUntilStop : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/WaitUntilStop", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WaitUntilStop); }
		}

		protected WaitUntilStop (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/constructor[@name='WaitUntilStop' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public WaitUntilStop (int p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (WaitUntilStop)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/constructor[@name='WaitUntilStop' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public WaitUntilStop (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.WaitUntilStop __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.WaitUntilStop> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Delay {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getDelay' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='setDelay' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='WaitUntilStop']/method[@name='getByteRepresentation' and count(parameter)=0]"
