...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']"
	[global::Android.Runtime.Register ("orbotix/macro/LoopStart", DoNotGenerateAcw=true)]
	public partial class LoopStart : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/LoopStart", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LoopStart); }
		}

		protected LoopStart (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/constructor[@name='LoopStart' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public LoopStart (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewArray (p0);;
			if (GetType () != typeof (LoopStart)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/constructor[@name='LoopStart' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public LoopStart (int p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.LoopStart __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.LoopStart> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		static void n_SetCount_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Orbotix.Macro.LoopStart __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.LoopStart> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Count = p0;
		}
#pragma warning restore 0169
		...
		static IntPtr id_setCount_I;
		public virtual int Count {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getCount' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='setCount' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setCount", "(I)V", "GetSetCount_IHandler")]
			set {
				if (id_setCount_I == IntPtr.Zero)
					id_setCount_I = JNIEnv.GetMethodID (class_ref, "setCount", "(I)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setCount_I, new JValue (value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setCount", "(I)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='LoopStart']/method[@name='getByteRepresentation' and count(parameter)=0]"
