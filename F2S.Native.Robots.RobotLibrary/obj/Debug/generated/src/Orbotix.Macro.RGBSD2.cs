...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']"
	[global::Android.Runtime.Register ("orbotix/macro/RGBSD2", DoNotGenerateAcw=true)]
	public partial class RGBSD2 : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/RGBSD2", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RGBSD2); }
		}

		protected RGBSD2 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_Integer_Ljava_lang_Integer_Ljava_lang_Integer_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/constructor[@name='RGBSD2' and count(parameter)=3 and parameter[1][@type='java.lang.Integer'] and parameter[2][@type='java.lang.Integer'] and parameter[3][@type='java.lang.Integer']]"
		[Register (".ctor", "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V", "")]
		public RGBSD2 (global::Java.Lang.Integer p0, global::Java.Lang.Integer p1, global::Java.Lang.Integer p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (RGBSD2)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V", new JValue (p0), new JValue (p1), new JValue (p2)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V", new JValue (p0), new JValue (p1), new JValue (p2));
				return;
			}

			if (id_ctor_Ljava_lang_Integer_Ljava_lang_Integer_Ljava_lang_Integer_ == IntPtr.Zero)
				id_ctor_Ljava_lang_Integer_Ljava_lang_Integer_Ljava_lang_Integer_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Ljava_lang_Integer_Ljava_lang_Integer_Ljava_lang_Integer_, new JValue (p0), new JValue (p1), new JValue (p2)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_lang_Integer_Ljava_lang_Integer_Ljava_lang_Integer_, new JValue (p0), new JValue (p1), new JValue (p2));
		}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/constructor[@name='RGBSD2' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public RGBSD2 (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.RGBSD2 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.RGBSD2> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getByteRepresentation' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='getColor' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RGBSD2']/method[@name='setColor' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
