...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']"
	[global::Android.Runtime.Register ("orbotix/macro/RotateOverTimeSD1", DoNotGenerateAcw=true)]
	public partial class RotateOverTimeSD1 : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/RotateOverTimeSD1", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RotateOverTimeSD1); }
		}

		protected RotateOverTimeSD1 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/constructor[@name='RotateOverTimeSD1' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public RotateOverTimeSD1 (int p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (RotateOverTimeSD1)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/constructor[@name='RotateOverTimeSD1' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public RotateOverTimeSD1 (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.RotateOverTimeSD1 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.RotateOverTimeSD1> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Angle;
		}
#pragma warning restore 0169
		...
		public virtual short Angle {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getAngle' and count(parameter)=0]"
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='getByteRepresentation' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotateOverTimeSD1']/method[@name='setAngle' and count(parameter)=1 and parameter[1][@type='int']]"
