...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']"
	[global::Android.Runtime.Register ("orbotix/macro/GoTo", DoNotGenerateAcw=true)]
	public partial class GoTo : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/GoTo", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (GoTo); }
		}

		protected GoTo (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/constructor[@name='GoTo' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public GoTo (int p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (GoTo)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/constructor[@name='GoTo' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public GoTo (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.GoTo __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.GoTo> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetGetIdentifierHandler ()
		{
			if (cb_getIdentifier == null)
				cb_getIdentifier = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_GetIdentifier);
			return cb_getIdentifier;
		}

		static int n_GetIdentifier (IntPtr jnienv, IntPtr native__this)
		{
			global::Orbotix.Macro.GoTo __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.GoTo> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static Delegate cb_setIdentifier_I;
#pragma warning disable 0169
		static Delegate GetSetIdentifier_IHandler ()
		{
			if (cb_setIdentifier_I == null)
				cb_setIdentifier_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetIdentifier_I);
			return cb_setIdentifier_I;
		}

		static void n_SetIdentifier_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Orbotix.Macro.GoTo __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.GoTo> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_setIdentifier_I;
		public virtual int Identifier {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getIdentifier' and count(parameter)=0]"
			[Register ("getIdentifier", "()I", "GetGetIdentifierHandler")]
			get {
				if (id_getIdentifier == IntPtr.Zero)
					id_getIdentifier = JNIEnv.GetMethodID (class_ref, "getIdentifier", "()I");

				if (GetType () == ThresholdType)
					return JNIEnv.CallIntMethod  (Handle, id_getIdentifier);
				else
					return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getIdentifier", "()I"));
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='setIdentifier' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setIdentifier", "(I)V", "GetSetIdentifier_IHandler")]
			set {
				if (id_setIdentifier_I == IntPtr.Zero)
					id_setIdentifier_I = JNIEnv.GetMethodID (class_ref, "setIdentifier", "(I)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setIdentifier_I, new JValue (value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setIdentifier", "(I)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='GoTo']/method[@name='getByteRepresentation' and count(parameter)=0]"
