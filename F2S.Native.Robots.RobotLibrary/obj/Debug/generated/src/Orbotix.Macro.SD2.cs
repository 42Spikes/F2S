...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']"
	[global::Android.Runtime.Register ("orbotix/macro/SD2", DoNotGenerateAcw=true)]
	public partial class SD2 : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/SD2", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SD2); }
		}

		protected SD2 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_Integer_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/constructor[@name='SD2' and count(parameter)=1 and parameter[1][@type='java.lang.Integer']]"
		[Register (".ctor", "(Ljava/lang/Integer;)V", "")]
		public SD2 (global::Java.Lang.Integer p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (SD2)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/constructor[@name='SD2' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public SD2 (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.SD2 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.SD2> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		...
		{
			if (cb_getDelay == null)
				cb_getDelay = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr>) n_GetDelay);
			return cb_getDelay;
		}

		static IntPtr n_GetDelay (IntPtr jnienv, IntPtr native__this)
		{
			global::Orbotix.Macro.SD2 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.SD2> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Delay);
		}
#pragma warning restore 0169

		static Delegate cb_setDelay_Ljava_lang_Integer_;
#pragma warning disable 0169
		static Delegate GetSetDelay_Ljava_lang_Integer_Handler ()
		{
			if (cb_setDelay_Ljava_lang_Integer_ == null)
				cb_setDelay_Ljava_lang_Integer_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_SetDelay_Ljava_lang_Integer_);
			return cb_setDelay_Ljava_lang_Integer_;
		}

		static void n_SetDelay_Ljava_lang_Integer_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Orbotix.Macro.SD2 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.SD2> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		static IntPtr id_setDelay_Ljava_lang_Integer_;
		public virtual global::Java.Lang.Integer Delay {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getDelay' and count(parameter)=0]"
			[Register ("getDelay", "()Ljava/lang/Integer;", "GetGetDelayHandler")]
			get {
				if (id_getDelay == IntPtr.Zero)
					id_getDelay = JNIEnv.GetMethodID (class_ref, "getDelay", "()Ljava/lang/Integer;");

				if (GetType () == ThresholdType)
					return global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (JNIEnv.CallObjectMethod  (Handle, id_getDelay), JniHandleOwnership.TransferLocalRef);
				else
					return global::Java.Lang.Object.GetObject<global::Java.Lang.Integer> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getDelay", "()Ljava/lang/Integer;")), JniHandleOwnership.TransferLocalRef);
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='setDelay' and count(parameter)=1 and parameter[1][@type='java.lang.Integer']]"
			[Register ("setDelay", "(Ljava/lang/Integer;)V", "GetSetDelay_Ljava_lang_Integer_Handler")]
			set {
				if (id_setDelay_Ljava_lang_Integer_ == IntPtr.Zero)
					id_setDelay_Ljava_lang_Integer_ = JNIEnv.GetMethodID (class_ref, "setDelay", "(Ljava/lang/Integer;)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setDelay_Ljava_lang_Integer_, new JValue (value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setDelay", "(Ljava/lang/Integer;)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='SD2']/method[@name='getByteRepresentation' and count(parameter)=0]"
