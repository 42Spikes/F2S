...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']"
	[global::Android.Runtime.Register ("orbotix/macro/Roll", DoNotGenerateAcw=true)]
	public partial class Roll : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {


		// Metadata.xml XPath field reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/field[@name='COMMAND_ID2']"
		[Register ("COMMAND_ID2")]
		public const sbyte CommandId2 = (sbyte) 29;
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/Roll", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (Roll); }
		}

		protected Roll (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_FII;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/constructor[@name='Roll' and count(parameter)=3 and parameter[1][@type='float'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register (".ctor", "(FII)V", "")]
		public Roll (float p0, int p1, int p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (Roll)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(FII)V", new JValue (p0), new JValue (p1), new JValue (p2)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(FII)V", new JValue (p0), new JValue (p1), new JValue (p2));
				return;
			}

			if (id_ctor_FII == IntPtr.Zero)
				id_ctor_FII = JNIEnv.GetMethodID (class_ref, "<init>", "(FII)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_FII, new JValue (p0), new JValue (p1), new JValue (p2)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_FII, new JValue (p0), new JValue (p1), new JValue (p2));
		}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/constructor[@name='Roll' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public Roll (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.Roll __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.Roll> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Delay {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getDelay' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='setDelay' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning disable 0169
		static Delegate GetGetHeadingHandler ()
		{
			if (cb_getHeading == null)
				cb_getHeading = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, int>) n_GetHeading);
			return cb_getHeading;
		}

		static int n_GetHeading (IntPtr jnienv, IntPtr native__this)
		{
			global::Orbotix.Macro.Roll __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.Roll> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.Heading;
		}
#pragma warning restore 0169

		static Delegate cb_setHeading_I;
#pragma warning disable 0169
		static Delegate GetSetHeading_IHandler ()
		{
			if (cb_setHeading_I == null)
				cb_setHeading_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetHeading_I);
			return cb_setHeading_I;
		}

		static void n_SetHeading_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Orbotix.Macro.Roll __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.Roll> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Heading = p0;
		}
#pragma warning restore 0169
		...
		static IntPtr id_setHeading_I;
		public virtual int Heading {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getHeading' and count(parameter)=0]"
			[Register ("getHeading", "()I", "GetGetHeadingHandler")]
			get {
				if (id_getHeading == IntPtr.Zero)
					id_getHeading = JNIEnv.GetMethodID (class_ref, "getHeading", "()I");

				if (GetType () == ThresholdType)
					return JNIEnv.CallIntMethod  (Handle, id_getHeading);
				else
					return JNIEnv.CallNonvirtualIntMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getHeading", "()I"));
			}
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='setHeading' and count(parameter)=1 and parameter[1][@type='int']]"
			[Register ("setHeading", "(I)V", "GetSetHeading_IHandler")]
			set {
				if (id_setHeading_I == IntPtr.Zero)
					id_setHeading_I = JNIEnv.GetMethodID (class_ref, "setHeading", "(I)V");

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setHeading_I, new JValue (value));
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setHeading", "(I)V"), new JValue (value));
			}
		}
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual float Speed {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getSpeed' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='setSpeed' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='Roll']/method[@name='getByteRepresentation' and count(parameter)=0]"
