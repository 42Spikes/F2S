...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']"
	[global::Android.Runtime.Register ("orbotix/macro/RotationRate", DoNotGenerateAcw=true)]
	public partial class RotationRate : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/RotationRate", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RotationRate); }
		}

		protected RotationRate (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/constructor[@name='RotationRate' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public RotationRate (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewArray (p0);;
			if (GetType () != typeof (RotationRate)) {
				SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/constructor[@name='RotationRate' and count(parameter)=1 and parameter[1][@type='float']]"
		[Register (".ctor", "(F)V", "")]
		public RotationRate (float p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.RotationRate __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.RotationRate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getByteRepresentation' and count(parameter)=0]"
		...
		static Delegate cb_getRotationRate;
#pragma warning disable 0169
		static Delegate GetGetRotationRateHandler ()
		{
			if (cb_getRotationRate == null)
				cb_getRotationRate = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, float>) n_GetRotationRate);
			return cb_getRotationRate;
		}

		static float n_GetRotationRate (IntPtr jnienv, IntPtr native__this)
		{
			global::Orbotix.Macro.RotationRate __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.RotationRate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetRotationRate ();
		}
#pragma warning restore 0169

		static IntPtr id_getRotationRate;
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='getRotationRate' and count(parameter)=0]"
		[Register ("getRotationRate", "()F", "GetGetRotationRateHandler")]
		public virtual float GetRotationRate ()
		{
			...
			if (GetType () == ThresholdType)
				...
				return JNIEnv.CallNonvirtualFloatMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getRotationRate", "()F"));
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RotationRate']/method[@name='setRotationRate' and count(parameter)=1 and parameter[1][@type='float']]"
