...
namespace Orbotix.Robot.Base {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SleepAsyncNotification']"
	[global::Android.Runtime.Register ("orbotix/robot/base/SleepAsyncNotification", DoNotGenerateAcw=true)]
	public sealed partial class SleepAsyncNotification : global::Orbotix.Robot.Base.DeviceAsyncData {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SleepAsyncNotification']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/robot/base/SleepAsyncNotification", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SleepAsyncNotification); }
		}

		internal SleepAsyncNotification (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorbotix_robot_base_Robot_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SleepAsyncNotification']/constructor[@name='SleepAsyncNotification' and count(parameter)=2 and parameter[1][@type='orbotix.robot.base.Robot'] and parameter[2][@type='byte[]']]"
