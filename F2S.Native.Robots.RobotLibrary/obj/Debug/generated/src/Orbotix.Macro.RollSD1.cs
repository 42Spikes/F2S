...
namespace Orbotix.Macro {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']"
	[global::Android.Runtime.Register ("orbotix/macro/RollSD1", DoNotGenerateAcw=true)]
	public partial class RollSD1 : global::Java.Lang.Object, global::Orbotix.Macro.IMacroCommand {


		// Metadata.xml XPath field reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/field[@name='ID']"
		[Register ("ID")]
		public const sbyte Id = (sbyte) 6;
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/macro/RollSD1", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RollSD1); }
		}

		protected RollSD1 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/constructor[@name='RollSD1' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public RollSD1 (byte[] p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			IntPtr native_p0 = JNIEnv.NewArray (p0);;
			if (GetType () != typeof (RollSD1)) {
				SetHandle (
		...
		static IntPtr id_ctor_FI;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/constructor[@name='RollSD1' and count(parameter)=2 and parameter[1][@type='float'] and parameter[2][@type='int']]"
		[Register (".ctor", "(FI)V", "")]
		public RollSD1 (float p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
			...
			if (GetType () != typeof (RollSD1)) {
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(FI)V", new JValue (p0), new JValue (p1)),
						JniHandleOwnership.TransferLocalRef);
				global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(FI)V", new JValue (p0), new JValue (p1));
				return;
			}

			if (id_ctor_FI == IntPtr.Zero)
				id_ctor_FI = JNIEnv.GetMethodID (class_ref, "<init>", "(FI)V");
			SetHandle (
					global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_FI, new JValue (p0), new JValue (p1)),
					JniHandleOwnership.TransferLocalRef);
			JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_FI, new JValue (p0), new JValue (p1));
		}

		static IntPtr id_getCommandID;
		public static sbyte CommandID {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getCommandID' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::Orbotix.Macro.RollSD1 __this = global::Java.Lang.Object.GetObject<global::Orbotix.Macro.RollSD1> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual int Heading {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getHeading' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='setHeading' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual int Length {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getLength' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual string SettingsString {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getSettingsString' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual float Speed {
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getSpeed' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='setSpeed' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='orbotix.macro']/class[@name='RollSD1']/method[@name='getByteRepresentation' and count(parameter)=0]"
