...
namespace Orbotix.Robot.Base {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SetMotionTimeoutResponse']"
	[global::Android.Runtime.Register ("orbotix/robot/base/SetMotionTimeoutResponse", DoNotGenerateAcw=true)]
	public partial class SetMotionTimeoutResponse : global::Orbotix.Robot.Internal.DeviceResponse {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SetMotionTimeoutResponse']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("orbotix/robot/base/SetMotionTimeoutResponse", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SetMotionTimeoutResponse); }
		}

		protected SetMotionTimeoutResponse (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lorbotix_robot_internal_DeviceCommand_arrayB;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SetMotionTimeoutResponse']/constructor[@name='SetMotionTimeoutResponse' and count(parameter)=2 and parameter[1][@type='orbotix.robot.internal.DeviceCommand'] and parameter[2][@type='byte[]']]"
		[Register (".ctor", "(Lorbotix/robot/internal/DeviceCommand;[B)V", "")]
		public SetMotionTimeoutResponse (global::Orbotix.Robot.Internal.DeviceCommand p0, byte[] p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='orbotix.robot.base']/class[@name='SetMotionTimeoutResponse']/constructor[@name='SetMotionTimeoutResponse' and count(parameter)=1 and parameter[1][@type='android.os.Parcel']]"
