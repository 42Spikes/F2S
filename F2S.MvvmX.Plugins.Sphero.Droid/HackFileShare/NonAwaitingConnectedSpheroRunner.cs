...
using F2S.MvvmX.Plugins.Sphero.Helpers;
using F2S.MvvmX.Plugins.Sphero.Interfaces;
using F2S.MvvmX.Plugins.Sphero.Messages;
using F2S.MvvmX.Plugins.Sphero.Sphero;

// ReSharper disable CheckNamespace

namespace F2S.MvvmX.Plugins.Sphero.HackFileShare
